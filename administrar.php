    ...
    <body>
        ...
        <div class="bd-example bd-example-tabs">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#usuario" role="tab" aria-controls="pills-profile" aria-selected="false">Usuário</a>
                </li>
                <li class="nav-item">
                <a class="nav-link active show" id="pills-contact-tab" data-toggle="pill" href="#mercado" role="tab" aria-controls="pills-contact" aria-selected="true">Mercado</a>
                </li>
            </ul>
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade" id="usuario" role="tabpanel" aria-labelledby="pills-profile-tab">
                <p>
                    <?php
                ...
                <div class="tab-pane fade active show" id="mercado" role="tabpanel" aria-labelledby="pills-contact-tab">
                <p>
                    <?php
